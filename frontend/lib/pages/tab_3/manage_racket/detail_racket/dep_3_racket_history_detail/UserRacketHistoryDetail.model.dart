...
//
//     final userRacketHistoryDetailModel = userRacketHistoryDetailModelFromJson(jsonString);

import 'dart:convert';

UserRacketHistoryDetailModel userRacketHistoryDetailModelFromJson(String str) =>
    UserRacketHistoryDetailModel.fromJson(json.decode(str));

String userRacketHistoryDetailModelToJson(UserRacketHistoryDetailModel data) =>
    json.encode(data.toJson());

class UserRacketHistoryDetailModel {
  UserRacketHistoryDetailModel({
    this.result,
  });

  Result result;

  factory UserRacketHistoryDetailModel.fromJson(Map<String, dynamic> json) =>
      UserRacketHistoryDetailModel(
