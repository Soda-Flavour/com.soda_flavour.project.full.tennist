...
class _RacketHistoryDetailScreenState extends State<RacketHistoryDetailScreen>
  ...
  Future<RacketHistoryDetailModel> serverData;
  ...
  void addItemToList() async {
    dynamic result = await RacketHistoryDetailProvider()
    ...
    if (result.status == 200) {
      ...
      ListElement data = ListElement(
          ...
          updatedDate: _result.data.updatedAt);
      ...
      if (result.errorCode == 'E2000') {
        return DialogPopUpWidget().needLoginDialogBox(context);
      } else {
    ...
    return Stack(
      ...
      children: <Widget>[
        Scaffold(
          ...
          body: FutureBuilder<RacketHistoryDetailModel>(
            future: serverData,
