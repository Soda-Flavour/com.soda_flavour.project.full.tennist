...
class dfdRacketHistoryScreen extends StatefulWidget {
...
class _RacketHistoryScreenState extends State<dfdRacketHistoryScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (isFirstLoading) {
      // serverData = RacketListProvider().getData(args.data['user_racket_id']);
